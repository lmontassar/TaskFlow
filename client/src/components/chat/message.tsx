  ...
  return (
    <div className={`flex ${isOwn ? "justify-end" : "justify-start"} mb-4 max-w-full`}>
      <div className={`max-w-[80%] ${isOwn ? "order-2" : "order-1"}`}>
        ...
        <Card className={`${isOwn ? "bg-blue-50 border-blue-100" : "bg-white"} shadow-sm`}>
          {referencedMessage && (
            <div className="px-4 pt-3 pb-0">
              <div className="border-l-2 border-gray-300 pl-3 py-1 text-sm text-gray-600 bg-gray-50 rounded-sm mb-2">
          ...
          {isEditing ? (
            ...
            <CardFooter className="flex justify-end p-2">
              <Button size="sm" variant="ghost" onClick={handleReply} className="h-7 px-2">
