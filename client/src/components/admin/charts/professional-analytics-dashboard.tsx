              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {kpis.avgTaskDuration.toFixed(1)} days
                    </span>
                  </div>
                  <Progress
                    value={(kpis.avgTaskDuration / 10) * 100}
                    className="h-2"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium">
                      {(
                        performanceTrends.reduce(
                          (sum, trend) => sum + trend.efficiency,
                          0
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="">
              ...
              <CardContent className="space-y-4">
                {teamWorkload.map((member, index) => (
                  <div
                    key={index}
                    className="space-y-3 p-4 bg-gradient-to-r from-slate-50 to-blue-50 rounded-lg"
                  >
                    ...
                    <div className="flex justify-between text-xs text-slate-500">
                      <span>
                        ${member.avgTaskValue.toLocaleString()} avg task value
                      </span>
                      <span>
                        {member.capacity - member.currentTasks > 0
                          ? `${
                              member.capacity - member.currentTasks
                            } slots available`
                          : "At capacity"}
                      </span>
                    </div>
            ...
            <Card className="">
              <CardHeader>
                ...
                <CardDescription>
                  Tasks completed vs completion rate analysis
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={400}>
