...
export function OptimizationChanges({ isOpen, onClose, onSave, optimizationResult }: OptimizationChangesProps) {
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            {task.oldData.collaborator.map((collab, index) => {
                              const newCollab = task.newData.collaborator.find((c) => c.id === collab.id)
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            {task.newData.collaborator.map((collab, index) => {
                              const oldCollab = task.oldData.collaborator.find((c) => c.id === collab.id)
                              const isNew = !oldCollab

                              return (
                                <div key={index} className={isNew ? "font-medium text-blue-700" : ""}>
                                  {collab.name}
                                  {isNew && (
                                    <Badge
                                      variant="outline"
